        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Klant Home (Alleen voor Klant en Admin) -->
                    ...
                    <!-- Magazijn links (Alleen voor Magazijnmedewerker en Admin) -->
                    @if (auth()->check() && in_array(strtolower(auth()->user()->rolename ?? ''), ['magazijnmedewerker', 'admin']))
